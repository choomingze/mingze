            ...
            style={{
                ...
                <h2>Skills</h2>
                    <div class="row" style={{marginTop:'5vh'}}>                       
                        ...
                        <div class="col-3 skill-card" style={{width:'24%'}}>
                            <div class="skill-bx wow zoomIn" style={{padding:'20px 0'}}>
                                <h2>Programming</h2>
                                <div style={{textAlign:'left',paddingLeft:'30px',paddingTop:'20px'}}>{listProgramming}</div>
                            </div>
                        </div>
                        <div class="col-3 skill-card" style={{width:'24%'}}>
                            <div class="skill-bx wow zoomIn" style={{padding:'20px 0'}}>
                                <h2>Tools</h2>
                                <div style={{textAlign:'left',paddingLeft:'30px',paddingTop:'20px'}}>{listTools}</div>
                            </div>
                        </div>
                        <div class="col-3 skill-card" style={{width:'24%'}}>
                            <div class="skill-bx wow zoomIn" style={{padding:'20px 0'}}>
                                <h2>Framework</h2>
                                <div style={{textAlign:'left',paddingLeft:'30px',paddingTop:'20px'}}>{listFrameworks}</div>
                            </div>
                        </div>
                        <div class="col-3 skill-card" style={{width:'24%'}}>
                            <div class="skill-bx wow zoomIn" style={{padding:'20px 0'}}>
                                ...
                                <div style={{textAlign:'left',paddingLeft:'30px',paddingTop:'20px'}}>{listLanguages}</div>
                            </div>
                        </div>
                    </div>
